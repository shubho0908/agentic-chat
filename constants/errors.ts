...
export const API_ERROR_MESSAGES = {
  ...
  OPENAI_RATE_LIMIT: "Your API key is being used too quickly. Please wait a moment and try again.",
  OPENAI_INSUFFICIENT_QUOTA: "Your OpenAI account has run out of credits. Please check your billing settings at platform.openai.com.",
