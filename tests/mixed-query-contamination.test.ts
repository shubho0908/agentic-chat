...
const attachments = [
  {
    fileName: "pasted-image-1790349012670.png",
    fileUrl: "https://utfs.io/f/long-image-name-here.png",
    fileType: "image/png",
    fileSize: 500,
  },
  {
    fileName: "Shubhojeet_Bera_Resume.pdf",
...
test("image URL helper text never becomes a PDF retrieval query", () => {
  ...
  assert.deepEqual(extractQueryTerms(routingText), [
    "dono",
    "attachment",
    "mein",
    "koi",
