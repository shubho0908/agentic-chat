          ...
          <div className="mx-auto max-w-[1400px]">
            <div className="flex flex-col items-center justify-between gap-[clamp(2.75rem,6vw,5rem)] lg:flex-row lg:items-center lg:gap-10 xl:gap-16">
              ...
              >
                ...
                >
                  Search the web, bring in documents, and keep the thread intact while you work. Add Google Workspace when it helps, and use your own key if you want to keep setup and billing on your side.
                </m.p>
