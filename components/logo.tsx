  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={g3} x1="2" x2="97.67" y1="27.12" y2="27.12" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" stopOpacity={0.8} offset="0" />
          <stop stopColor="#fff" stopOpacity={0.2} offset="1" />
        </linearGradient>
        <linearGradient id={g4} x1="50" x2="50" y1="99.32" y2="0" gradientUnits="userSpaceOnUse">
          <stop stopColor="#003DAC" stopOpacity={0.2} offset="0" />
          <stop stopColor="#003DAC" stopOpacity={0} offset="1" />
        </linearGradient>
      </defs>
      ...
      <path fill={`url(#${g3})`} d="m77.6 0.7h-55.2c-11.1 0-20.9 9.4-20.9 21.4v0.9c0.8-11.4 9.8-21.5 20.9-21.5h55.2c10.7 0 19.4 9 20.1 20.6v-0.4c0-12-9-21-20.1-21z" />
      <path fill={`url(#${g4})`} d="m77.6 0.7h-55.2c-11.6 0-20.9 9-20.9 21.4v55.2c0 11.7 9.3 21.7 20.9 21.7h55.2c11.4 0 20.7-10 20.7-21.7v-55.2c0-11.6-9.3-21.4-20.7-21.4z" />
